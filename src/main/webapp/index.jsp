...
<div data-options="region:'west',title:'系统菜单',split:true" style="width:200px;">
    <div id="aa" class="easyui-accordion" style="width:193px;" data-options="border:0,multiple:true">
        <div title="核算系统" data-options="iconCls:'icon-edit',selected:true" style="padding:10px;">
            <ul>
                <li><a style="color: #8A2BE2" href="javascript:void(0)" pageUrl="list.jsp">核算操作页面</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div data-options="region:'center'" style="padding:5px;">
    <div id="tt" class="easyui-tabs" style="width:500px;height:250px;" data-options="fit:true">
        <div title="欢迎页面" style="padding: 20px; overflow: hidden; color: #8A2BE2;">
            <p style="font-size: 25px; line-height: 30px; height: 30px;">欢迎使用核算系统</p>
            ...
            <p>服务器: Tomcat 9.0</p>
            <p>数据库:  MySQL </p>
            <p>采用技术:Spring+Spring MVC+MyBatis+jQuery+EasyUI+Maven+Poi</p>
        </div>
    </div>
</div>
